        ...
        if language == "ru_RU": # Russian
            if where == "message":
                ...
                locale = {
                    ...
                    'about_linksv3': '[Исходный код]({0})\r\n_лицензии: [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) и [GNU Affero GPL 3.0 (или выше)](https://www.gnu.org/licenses/agpl-3.0.html)_',
            ...
            if where == "message":
                ...
                locale = {
                    ...
                    'about_linksv3': '[Source code]({0})_licenses: [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) and [GNU Affero GPL 3.0 (or higher)](https://www.gnu.org/licenses/agpl-3.0.html)_',
