        ...
        if language == "ru_RU": # Russian
            if where == "message":
                ...
                locale = {
                    ...
                    'about_licensesv': 'Это свободное программное обеспечение с открытым исходным кодом, предназначенное для работы в сетевыми API и распространяемое в соответствии с условиями [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) и [GNU Affero GPL 3.0 (или выше)](https://www.gnu.org/licenses/agpl-3.0.html).',
            ...
            if where == "message":
                ...
                locale = {
                    ...
                    'about_licensesv': 'This is free software with open source, designed to work in network APIs and distributed under the terms of the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) и [GNU Affero GPL 3.0 (or higher)](https://www.gnu.org/licenses/agpl-3.0.html).',
                    'user_nickf': 'Nickname',
                    'user_nickv': '{0}',
                    'user_nickvn': '*Missing*',
