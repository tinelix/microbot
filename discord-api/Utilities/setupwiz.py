...
def gen_config_file(sys, config, links):
 ...
 (for example, Microbot modifications).
 ...
 2. Affero GPLv3 or later version
    This option guarantees all users full freedom of action under equal terms. Requires the public release of
    modified source code.

 3. Apache License 2.0
    Useful mainly for beginners or inexperienced developers. Anyone can use this work as a template for drawing
    up an initial development concept without worrying about changes to the source code.
""")
        license_choice = int(input(" Your choice (1-3): "))
        if(license_choice == 1 or license_choice == 2 or license_choice == 3):
